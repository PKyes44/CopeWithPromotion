...
import com.example.chatapp.adapter.ChatFirebaseAdapter;
import com.example.chatapp.adapter.ClickListenerChatFirebase;
import com.example.chatapp.model.ChatModel;
import com.example.chatapp.model.FileModel;
import com.example.chatapp.model.MapModel;
...
//    private EmojIconActions emojIcon;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.sendPhoto) {
            verifyStoragePermissions();
//                photoCameraIntent();
        } else if (itemId == R.id.sendPhotoGallery) {
            photoGalleryIntent();
        } else if (itemId == R.id.sendLocation) {
    ...
    private void sendMessageFirebase(){
        ChatModel model = new ChatModel(userModel,
                    null,
//                edMessage.getText().toString(),
                Calendar.getInstance().getTime().getTime()+"",null);
